...
export default function Category() {
  ...
  const fetchCategories = async () => {
    try {
      ...
      const list: CategoryGroup[] = Array.isArray(result) ? result : [];
      setCategories(list);
    } catch (error) {
    ...
    <View className="category-page">
      ...
      >
        {categories.map((cat, index) => (
          ...
          >
            <Text className="category-sidebar__text">{cat.name}</Text>
          </View>
        ))}
      </ScrollView>
      ...
      >
        {activeCategory && (
          <View className="category-content__header">
            ...
            <Text className="category-content__title">{activeCategory.name}</Text>
          </View>
        )}
